...
class Classifier(assetManager: AssetManager, modelPath: String, labelPath: String, inputSize: Int) {
    ...
    fun recognizeImage(bitmap: Bitmap): List<Recognition> {
        ...
        // comverting bitmap to list of pixels
    ...
    private fun convertBitmapToByteBuffer(bitmap: Bitmap): ByteBuffer {
        ...
        for (i in 0 until INPUT_SIZE) {
            for (j in 0 until INPUT_SIZE) {
                ...
                //
                // normalizing images , and converting ARGB to RGB images
    ...
    private fun getSortedResult(labelProbArray: Array<FloatArray>): List<Classifier.Recognition> {
        ...
        // priority Queue gives the prediction of both classes respectively i.e cats and dogs for each image
        ...
        for (i in lableList.indices) {
            ...
            if (confidence >= THRESHOLD) { // we have set default probability to 0.4
